...
const HeroSection = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen w-full px-4 sm:px-6 md:px-8 lg:px-10 xl:px-20 bg-cover bg-center text-white overflow-auto">
      {/* Main Content */}
      <div className="text-center relative z-10 max-w-7xl mx-auto">
        ...
        <motion.h1
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8 }}
          className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl text-[#28282B] font-semibold font-poppins leading-tight mb-4"
        >
          <span className="block sm:inline">Transform into a Data Pro</span>
          <br className="hidden sm:block" />
          <span className="bg-gradient-to-r from-[#0F172A] via-[#00A3B5] to-[#68D391] bg-clip-text text-transparent font-bold block sm:inline mt-2 sm:mt-0">
            Learn, Build, and Succeed!
          </span>
        </motion.h1>
        ...
        <motion.p
          ...
          animate={{ opacity: 1 }}
          transition={{ duration: 0.8, delay: 0.4 }}
          className="text-sm sm:text-base md:text-lg lg:text-xl text-[#170f00ec] font-regular max-w-xs sm:max-w-md md:max-w-2xl lg:max-w-4xl xl:max-w-5xl mx-auto mt-4 sm:mt-6 text-center font-poppins leading-relaxed px-2"
        >
          Kickstart your data career with <b>DataCliq</b> – the ultimate platform for aspiring data analysts! Gain
          expertise in tools like Excel, SQL, and Tableau, and build real-world projects to stand out.
        </motion.p>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.6 }}
          className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center mt-6 sm:mt-8 md:mt-10 px-4"
        >
          {/* Explore Courses Button */}
          <button
            type="submit"
            className="inline-flex items-center justify-center shadow-xl text-sm sm:text-base md:text-lg bg-[#10B981] backdrop-blur-md font-medium sm:font-semibold border-gray-50 before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-[#0FA070] hover:text-white before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-4 sm:px-6 md:px-8 py-2 sm:py-3 overflow-hidden border-2 rounded-full group transition-all duration-300 ease-in-out w-full sm:w-auto min-w-[160px] sm:min-w-[180px]"
          >
            <span className="relative z-10">Explore Courses</span>
            <span className="ml-0 opacity-0 translate-x-2 group-hover:ml-2 group-hover:opacity-100 group-hover:translate-x-0 ease-in-out duration-300 text-gray-800 group-hover:text-teal-800">
              &gt;
          ...
          <button
            type="button"
            className="inline-flex items-center justify-center shadow-xl text-sm sm:text-base md:text-lg backdrop-blur-md font-medium sm:font-semibold border-[#10B981] text-[#10B981] hover:text-white before:absolute before:w-full before:transition-all before:duration-700 before:hover:w-full before:-left-full before:hover:left-0 before:rounded-full before:bg-[#0FA070] before:-z-10 before:aspect-square before:hover:scale-150 before:hover:duration-700 relative z-10 px-4 sm:px-6 md:px-8 py-2 sm:py-3 overflow-hidden border-2 rounded-full group transition-all duration-300 ease-in-out w-full sm:w-auto min-w-[160px] sm:min-w-[200px]"
          >
            <span className="relative z-10">Download Cheatsheet</span>
            <span className="ml-0 opacity-0 translate-x-2 group-hover:ml-2 group-hover:opacity-100 group-hover:translate-x-0 ease-in-out duration-300 text-teal-500 group-hover:text-teal-800">
              &gt;
